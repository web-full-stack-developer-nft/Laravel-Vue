            ...
            <div class="flex relative inline-block pr-6">
                ...
                <div class="relative text-sm">
                    <div class="flex">
                    	<template v-if="token"> 
							  <button id="userButton" class="flex items-center focus:outline-none mr-3" @click="dropdown()">
                                <img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of User"> <span v-if="user" class="hidden md:inline-block">Hi, {{ user.name }} </span>
                    ...
                    <div id="userMenu" v-bind:class="activeClass ? '' : 'hidden'"  class="bg-white nunito rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30">
                        <ul class="list-reset">
                            <li><router-link @click="activeClass=false" to="/settings" class="px-4 py-2 block text-gray-900 hover:bg-indigo-400 hover:text-white no-underline hover:no-underline">My account</router-link></a></li>
                            ...
                            <li><a href="#" class="px-4 py-2 block text-gray-900 hover:bg-indigo-400 hover:text-white no-underline hover:no-underline" @click="logout">Logout</a></li>
                        </ul>
                    </div>
                </div>
